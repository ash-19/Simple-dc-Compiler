...
/***************************** Productions that define grammar *******************/
  ...
  String etype;
    ...
    case VAR:
      ...
      if (!types.get(t.image).equals(etype))
          {
                  {if (true) throw new TypeException("Type mismatch: " + types.get(t.image) + "=" + etype);}
      }
    ...
    case BOOLEANTYPE:
      ...
      if (types.get(t.image) == null)
      {
        ...
        variables.put(t.image, (char) ('A' + variables.size()));
                ...
                {
                  {if (true) throw new TypeException("Type mismatch: " + vtype.image + "=" + etype);}
                }
    ...
    case READ:
      ...
      if (!types.get(t.image).equals("int"))
          {
                  {if (true) throw new TypeException("Type mismatch, need a int variable.");}
      }
    ...
    if (!etype.equals("boolean"))
        {
          {if (true) throw new TypeException("Type mismatch: " + "if (" + etype + ")");}
        }
        System.out.print("[");
      block();
  ...
  String type1, type2;
    ...
    while (true) {
      ...
      type2 = greatOrLessExp();
      if (!type1.equals(type2))
          {
                  {if (true) throw new TypeException("Type mismatch: " + type1 + t.image + type2);}
      }
      if (variables.size() >= 26)
      {
        {if (true) throw new TypeException("Too many variables; limit is 26");}
  ...
  final public String greatOrLessExp() throws ParseException {
  Token t;
  String type1, type2;
  ...
  final public String arithematicExp() throws ParseException {
  Token t;
  String type1, type2;
    type1 = term();
    label_5:
  ...
  String type;
    ...
    case NOT:
      ...
      type = element();
                ...
                {
                  {if (true) throw new TypeException("Type mismatch: " + "!" + type);}
                }
